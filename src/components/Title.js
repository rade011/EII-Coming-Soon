...
const Title = () => (
  <Wrapper>
    <Heading heading="Welcome to the new" subheading="Education Improvement Institute Website" content="Works in progress coming soon"/>
    <Instagram href="#" className="icon-instagram" />
    <Email href="mailto:Office@eii.edu.euSubject=Hello%20again" className="icon-mail2" />
    <Vimeo href="#" className="icon-vimeo" />
  </Wrapper>
);
